...
public class CountMusicHeat {
    ...
    static final String OUTPUT_PATH = "hdfs://10.211.55.41:9000/output/music/1";
    ...
    public static void main(String[] args) throws URISyntaxException, IOException, InterruptedException, ClassNotFoundException {
        ...
        Path inpath1 = new Path(CountMusicHeat.INPUT_PATH1);
        Path inpath2 = new Path(CountMusicHeat.INPUT_PATH2);
        Path inpath3 = new Path(CountMusicHeat.INPUT_PATH3);
        ...
        //开始数据分析
        Job job = Job.getInstance(conf, "countmusicheat");
        //数据从哪读
    ...
    static class MyMapper extends Mapper<LongWritable, Text, Text, LongWritable> { //k1,v1,k2,v2的类型
        ...
        protected void map(LongWritable key, Text value,
            ...
            context.write(new Text(datas[1]), new LongWritable(1));
        }
    }
    ...
    static class MyReducer extends Reducer<Text, LongWritable, Text, LongWritable> { //k2,v2,k3,v3的类型
        ...
        protected void reduce(Text k2, Iterable<LongWritable> v2s,
            ...
            context.write(k2, new LongWritable(musicHeat));
        }
    }
}
