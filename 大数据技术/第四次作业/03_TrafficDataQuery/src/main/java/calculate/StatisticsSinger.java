...
public class StatisticsSinger {
    ...
    public static void main(String[] args) throws URISyntaxException, IOException, InterruptedException, ClassNotFoundException {
        ...
        Path inpath1 = new Path(StatisticsSinger.INPUT_PATH1);
        Path inpath2 = new Path(StatisticsSinger.INPUT_PATH2);
        Path inpath3 = new Path(StatisticsSinger.INPUT_PATH3);
        ...
        //开始数据分析
        Job job = Job.getInstance(conf, "statisticssinger");
        //数据从哪读
    ...
    static class MyMapper extends Mapper<LongWritable, Text, Text, LongWritable> { //k1,v1,k2,v2的类型
        ...
        protected void map(LongWritable key, Text value,
            ...
            context.write(new Text(datas[2]), new LongWritable(1));
        }
    }
