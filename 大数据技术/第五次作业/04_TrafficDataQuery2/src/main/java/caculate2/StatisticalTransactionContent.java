 ...
 */
public class StatisticalTransactionContent {

    static final String INPUT_PATH = "hdfs://localhost:9000/input/bank-data.csv";

    static final String OUTPUT_PATH = "hdfs://localhost:9000/output/bank/2";
    ...
    static class MyMapper extends Mapper<LongWritable, Text, Text, LongWritable> {
        ...
        protected void map(LongWritable key, Text value, Mapper<LongWritable, Text, Text, LongWritable>.Context context) throws IOException, InterruptedException {
           String data = value.toString();
            ...
            context.write(new Text(datas[7]),new LongWritable(1));
        }
    }
    ...
    public static void main(String[] args) throws URISyntaxException, IOException, InterruptedException, ClassNotFoundException {
        ...
        Path inpath = new Path(StatisticalTransactionContent.INPUT_PATH);
        Path outpath = new Path(StatisticalTransactionContent.OUTPUT_PATH);
        //判断输出文件的地址是否存在
